  ...
  <div class="admin-borrow">
    <div class="borrow-box">
      ...
      <div @click="openSelectModal">
        <NormalViewBox class="borrow-box-item">
          <div class="title-container">
            <h1>PREVIEW</h1>
            <h3>查看并编辑所有借阅</h3>
          </div>
          <div class="img-container">
            <img v-lazy="'/assets/images/background11.png'" alt="borrow" />
          </div>
        </NormalViewBox>
      </div>
      <!-- 借阅查看模态框 -->
        ...
        <div class="select-text">
          ...
          <div class="search-box">
            ...
            <input
              ...
              class="search-input"
              type="text"
              placeholder="搜索借阅图书或用户"
            />
          </div>
          <div class="select-tips">*双击借阅属性可进行编辑</div>
        </div>
        <SelectBorrow :searchText="searchText"></SelectBorrow>
      </NormalModal>
      ...
      <div @click="openAddModal">
        <NormalViewBox class="borrow-box-item">
          ...
          <div class="img-container">
            <img v-lazy="'/assets/images/background12.png'" alt="borrow" />
          </div>
        </NormalViewBox>
      </div>
      <!-- 借阅添加模态框 -->
      <NormalModal v-if="isAddModalVisible" class="select-modal" size="large">
        <div class="select-text">添加借阅</div>
        <AddBorrow></AddBorrow>
      </NormalModal>
    </div>
  </div>
...
import SelectBorrow from "@/components/admin/SelectBorrow.vue";
...
.borrow-box-item:hover .title-container {
  justify-content: center;
  align-items: center;
  width: 100%;
  height: 100%;
...
.borrow-box-item:hover h1,
.borrow-box-item:hover h3 {
  text-align: center;
  margin: 0;
}
